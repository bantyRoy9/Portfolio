    ...
    <div className="skills section__padding" id="skill">
      <div className="skills-heading">
        ...
        <h1 className="gradient__text">
          The future is now and We just need to realize it. Step into Future
            ...
            <div className="Skills__content skills-open">
              ...
              <div className="skills__list grids">
                ...
                <div className="skills__data">
                  ...
                  <div className="skills__bar">
                    <span className="skills__percentage skills__ractjs"></span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="Skills__content skills__open">
          ...
          <div class="skills__list grids">
            ...
            <div class="skills__data">
              ...
              <div class="skills__bar">
                <span class="skills__percentage skills__C-Programming"></span>
              </div>
            </div>
